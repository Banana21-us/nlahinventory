    ...
    <div class="bg-white shadow-md rounded-lg border border-gray-200 overflow-hidden"
        ...
        >
            <div class="flex items-center">
                <div class="p-2 bg-sky-50 rounded-lg mr-4">
                ...
                <h2 class="text-lg font-bold text-gray-800">Asset Entry</h2>
            </div>
            <span class="text-sm font-medium text-sky-600" x-text="open ? 'Minimize' : 'Add Asset'"></span>
        </button>
        ...
        >
            <form wire:submit.prevent="save" class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                <div>
                ...
                <div class="md:col-span-2 xl:col-span-3 flex justify-end items-center gap-3 pt-4 border-t border-gray-100 mt-2">
                    ...
                    <button
                        type="submit"
                        class="bg-sky-600 hover:bg-sky-700 text-white text-sm font-bold py-2 px-10 rounded shadow-md transition-all active:scale-95 flex items-center gap-2"
                    >
        ...
        <div class="bg-gray-50 px-6 py-4 border-b border-gray-200 flex flex-wrap gap-3 justify-between items-center">
            ...
            <div class="relative">
                <input
                    ...
                    class="pl-4 pr-4 py-2 text-sm bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-sky-400 focus:border-transparent transition-all w-64"
                />
            </div>
        </div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="mt-1.5 text-sm text-gray-500">
                                    Are you sure you want to remove this asset record? This action cannot be undone.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <form wire:submit.prevent="update">
                        <div class="bg-white px-6 pt-6 pb-4">
                            <div class="flex items-center mb-5 pb-4 border-b border-gray-100">
                                ...
                                <h3 class="text-xl font-bold text-gray-900">Update Asset</h3>
                            </div>
                        ...
                        <div class="bg-gray-50 px-6 py-4 flex flex-row-reverse gap-3 rounded-b-xl">
                            <button
                                type="submit"
                                class="inline-flex justify-center rounded-lg bg-sky-600 px-5 py-2 text-sm font-bold text-white shadow-sm hover:bg-sky-700 transition-colors active:scale-95 flex items-center gap-2"
                            >
