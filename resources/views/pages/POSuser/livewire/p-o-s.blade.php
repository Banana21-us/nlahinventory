...
@endif
            ...
            >
                ...
                @if($payment_method !== 'Credit' && $this->subtotal > 0)
                    @if((float) $this->paid_amount <= 0)
                        <div class="mt-2 rounded-xl border border-red-200 bg-red-50 px-3 py-2 text-xs font-semibold text-red-600">
                            Enter the tendered amount before checking out.
                        </div>
                    @elseif((float) $this->paid_amount < $this->subtotal)
                        <div class="mt-2 rounded-xl border border-red-200 bg-red-50 px-3 py-2 text-xs font-semibold text-red-600">
                            Tendered amount is not enough for this order.
                        </div>
                    @endif
                @endif
            </div>
