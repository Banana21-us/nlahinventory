        ...
        <div class="p-6 space-y-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-xl font-bold tracking-tight text-slate-900">Storefront</h1>
                        <p class="text-xs font-medium text-slate-500 uppercase tracking-wider">Terminal #01</p>
                    </div>
                </div>
