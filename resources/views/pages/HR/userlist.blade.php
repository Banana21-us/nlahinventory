    ...
    <div class="bg-white shadow-md rounded-lg border border-gray-200 overflow-hidden"
        ...
        >
            <form wire:submit.prevent="save" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    <label class="block text-xs font-bold uppercase tracking-wide text-gray-500 mb-1">Role</label>
            ...
            <table class="w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-100">
                    @forelse($users as $user)
                        @php
                            $roleStyles = [
                                'HR'          => 'background-color:#ede9fe;color:#6b21a8;border:1px solid #c4b5fd;',
                                'Maintenance' => 'background-color:#fef9c3;color:#854d0e;border:1px solid #fde047;',
                                'Inspector'   => 'background-color:#e6f4f5;color:#027c8b;border:1px solid #a5d8dd;',
                                'Staff'       => 'background-color:#dcfce7;color:#166534;border:1px solid #86efac;',
                                'Disable'     => 'background-color:#fee2e2;color:#991b1b;border:1px solid #fca5a5;',
                            ];
                        @endphp
                        <tr class="brand-row-hover transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <span class="px-2.5 py-0.5 inline-flex text-xs leading-5 font-semibold rounded-full"
                                      style="{{ $roleStyles[$user->role] ?? 'background-color:#f3f4f6;color:#374151;border:1px solid #d1d5db;' }}">
                                    {{ $user->role }}
                                </span>
                            </td>
