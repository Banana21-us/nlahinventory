                ...
                <tbody class="bg-white divide-y divide-gray-100">
                    @forelse($holidays as $holiday)
                        ...
                        <tr class="brand-row-hover transition-colors">
                            <td class="px-6 py-4 text-sm font-semibold text-gray-800">{{ $holiday->date->format('M d, Y') }}</td>
                            <td class="px-6 py-4 text-sm font-bold text-gray-900">{{ $holiday->name }}</td>
                            <td class="px-6 py-4">
                                <span class="px-2.5 py-0.5 inline-flex text-xs leading-5 font-bold rounded-full {{ $typeBadge[0] }}">
                                    {{ $typeBadge[1] }}
                                </span>
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4 text-sm text-gray-500">{{ $holiday->remarks ?? '—' }}</td>
                            <td class="px-6 py-4 text-right text-sm font-medium space-x-2">
                                <button wire:click="edit({{ $holiday->id }})" class="brand-edit-btn rounded-md px-2.5 py-1.5 text-sm font-semibold shadow-sm transition-colors">Edit</button>
                                <button wire:click="confirmDelete({{ $holiday->id }})" class="text-red-500 hover:text-red-700 font-semibold transition-colors">Delete</button>
                            </td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-14 text-center">
                                <div class="flex flex-col items-center text-gray-400">
                                    ...
                                    <p class="text-xs mt-1">{{ $search ? 'Try a different keyword.' : 'Click "Add New Holiday" above to get started.' }}</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
