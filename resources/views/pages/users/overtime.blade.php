    ...
    <div class="flex items-center justify-between mb-6">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 mt-0.5">Submit and track your overtime and on-call requests</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white shadow-md rounded-xl border border-gray-200 overflow-hidden mb-6"
        ...
        <button @click="open = !open"
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="text-left">
                    <h2 class="text-base font-bold text-gray-800">New Overtime Application</h2>
        ...
        <div x-show="open" x-collapse class="border-t border-gray-100">
            <div class="p-5 brand-bg-primary-light border-b border-blue-100 flex items-center gap-3">
                <div class="p-2 rounded-lg brand-bg-primary">
                    <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                    </svg>
                </div>
                <p class="text-xs text-gray-600">Hours are auto-computed from your start and end date/time. Select <strong>Overtime</strong> for regular extended work, or <strong>On Call</strong> for standby duty.</p>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div>
                        ...
                        <select wire:model="type"
                            class="brand-focus block w-full rounded-lg border border-gray-300 shadow-sm text-sm p-2.5 bg-white">
                    ...
                    <div class="lg:col-span-4">
                        ...
                        <input type="text" wire:model="reason" placeholder="Brief reason for overtime/on-call"
                            class="brand-focus block w-full rounded-lg border border-gray-300 shadow-sm text-sm p-2.5"/>
    ...
    <div class="bg-white shadow-md rounded-xl overflow-hidden border border-gray-200">
        <div class="px-6 py-4 border-b border-gray-200 flex flex-wrap gap-3 justify-between items-center bg-gray-50">
            <div class="flex items-center gap-3">
                ...
                <span class="text-xs font-semibold brand-bg-teal-light brand-text-teal px-2.5 py-0.5 rounded-full">
                        ...
                        <tr>
                            <td colspan="8" class="px-6 py-16 text-center">
                                <div class="flex flex-col items-center text-gray-400">
                                    ...
                                    <p class="text-sm font-medium">No overtime applications yet.</p>
                                    <p class="text-xs mt-1">Click "Apply Now" above to submit your first request.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
                    ...
                    <form wire:submit.prevent="update">
                        <div class="px-6 py-4 border-b border-gray-200 brand-bg-teal-light flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <h3 class="text-base font-bold text-gray-800">Edit Overtime Application</h3>
                            </div>
                        ...
                        <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-xs font-bold uppercase tracking-wide text-gray-500 mb-1">Type *</label>
                                <select wire:model="type"
                                    class="brand-focus block w-full rounded-lg border border-gray-300 text-sm p-2.5 bg-white">
                                    <option value="overtime">Overtime</option>
                                    <option value="on_call">On Call</option>
                                </select>
                            </div>
