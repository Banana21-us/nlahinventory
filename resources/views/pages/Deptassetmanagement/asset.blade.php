        ...
        <div class="bg-white rounded-xl shadow-md border border-gray-200 p-12 text-center">
            <div class="flex flex-col items-center">
                ...
                <p class="text-sm text-gray-500 max-w-md">
                    {{ $search ? 'No assets match your search criteria.' : 'No assets are currently assigned to your department.' }}
                </p>
                @if($search)
            ...
            <div class="flex min-h-full items-center justify-center p-4">
                <div class="relative transform overflow-hidden rounded-xl bg-white text-left shadow-xl sm:w-full sm:max-w-2xl w-full max-w-2xl">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-indigo-200">{{ $selectedAsset->asset_code }}</p>
                                </div>
                            </div>
                            ...
                            <div class="md:w-1/2 space-y-3">
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    <div>
                                        ...
                                        <p class="text-gray-700">{{ $selectedAsset->purchase_date ? date('M d, Y', strtotime($selectedAsset->purchase_date)) : 'N/A' }}</p>
                                    </div>
                                    <div>
                    ...
                    <div class="bg-gray-50 px-6 py-4 flex justify-end gap-3 rounded-b-xl">
                        <button 
                            type="button" 
                            wire:click="openUpdateModal({{ $selectedAsset->id }})" 
