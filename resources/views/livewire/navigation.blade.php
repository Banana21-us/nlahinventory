...
<header
    ...
    <nav
        class="flex items-center justify-between w-full max-w-4xl h-14 px-4 bg-white/70 backdrop-blur-xl border border-zinc-200/50 rounded-full shadow-sm">

        {{-- Logo --}}
        <div class="flex items-center gap-2 pl-2">
            <a
                href="{{ route('nlah.home') }}"
            ...
            <div
                ...
                <div class="relative" id="desktop-options-wrapper">
                    ...
                    <div
                        ...
                        <ul class="flex flex-col list-square list-inside">

                            <li class="list-disc">
                                <a
                                    href="{{ route('login') }}"
                                    class="inline-flex items-center px-4 py-2 text-sm font-medium tracking-wide text-zinc-800 hover:bg-zinc-100 transition-colors ">
                                    NLAH Portal
                                </a>
                            </li>
        ...
        <div class="flex items-center gap-2">
            ...
            {{-- Facebook --}}
            <a
                href="https://www.facebook.com/nlahospitalinc"
                target="_blank"
            ...
            <div class="md:hidden" wire:ignore="wire:ignore">
                <button
                    id="mobile-menu-btn"
                    ...
                    {{ request()->routeIs('nlah.about') ? 'bg-zinc-100 text-black' : 'text-zinc-700 hover:bg-zinc-50 hover:text-black' }}"
                        ...
                        <div>
                            ...
                            <div
                                id="options-body"
                                style="display:none;"
                                class="ml-4 mb-1 flex flex-col border-l-2 border-zinc-100 pl-3">
                                <li class="list-disc">
                                    <a
                                        href="{{ route('login') }}"
                                        class="inline-flex items-center px-4 py-2 text-sm font-medium  tracking-wide text-zinc-800 hover:bg-zinc-100 transition-colors ">
        ...
        <div class="flex flex-col p-2">
            ...
            <div>
                ...
                <div
                    id="options-body"
                    style="display:none;"
                    class="ml-4 mb-1 border-l-2 border-zinc-100 pl-3">
                    <ul class="flex flex-col gap-1">
                        ...
                        <li>
                            <hr class="my-1 border-zinc-100"></li>
                            <li>
                                <a
                                    href="#"
                                    class="px-3 py-2.5 rounded-lg text-sm text-zinc-600 hover:bg-zinc-50 hover:text-black transition-colors">
        ...
        <script>
            function toggleMobileMenu() {
                ...
                menu.style.display = isOpen
                    ? 'none'
                    : 'block';
                hamburger.style.display = isOpen
                    ? 'block'
                    : 'none';
                close.style.display = isOpen
                    ? 'none'
                    : 'block';
                ...
                if (isOpen) {
                    document
                        .getElementById('options-body')
                        .style
                        .display = 'none';
                    document
                        .getElementById('options-chevron')
                        .style
                        .transform = '';
                }
            }
        ...
        <script>
            ...
            document.addEventListener('click', function (e) {
                ...
                if (desktopWrapper && !desktopWrapper.contains(e.target)) {
                    document
                        .getElementById('desktop-options-menu')
                        .style
                        .display = 'none';
                    document
                        .getElementById('desktop-options-chevron')
                        .style
                        .transform = '';
                }
            });
