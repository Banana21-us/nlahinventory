    ...
    <div class="bg-white shadow-md rounded-lg border border-gray-200 overflow-hidden"
        ...
        <button @click="open = !open"
            ...
            <div class="flex items-center">
                ...
                <h2 class="text-lg font-bold text-gray-800">New Pay-off Application</h2>
            </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <input type="number" step="0.5" wire:model="hours" placeholder="e.g. 4"
                ...
                <tbody class="bg-white divide-y divide-gray-100">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $applications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $app): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        ...
                        <tr class="brand-row-hover transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <span class="text-sm font-semibold brand-text-primary"><?php echo e($app->hours); ?>h</span>
                            </td>
                            ...
                            <td class="px-6 py-4 text-sm text-gray-600 max-w-xs truncate"><?php echo e($app->reason ?? '—'); ?></td>
                            <td class="px-6 py-4">
                    ...
                    <form wire:submit.prevent="update">
                        <div class="px-6 pt-6 pb-4">
                            <div class="flex items-center mb-5 pb-4 border-b border-gray-100">
                                ...
                                <h3 class="text-xl font-bold text-gray-900">Update Pay-off Application</h3>
                            </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div>
                                    <label class="block text-xs font-bold uppercase tracking-wide text-gray-500 mb-1">Hours *</label>
                                    <input type="number" step="0.5" wire:model="hours" class="brand-focus block w-full rounded-md border border-gray-300 shadow-sm sm:text-sm p-2"/>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['hours'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php /**PATH C:\Users\JOHNPAUL\OneDrive\Documents\GitHub\nlahinventory\resources\views/pages/HR/payoff-management.blade.php ENDPATH**/ ?>