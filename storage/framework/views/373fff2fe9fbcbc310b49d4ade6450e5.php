                            ...
                            <div class="mb-2 flex gap-1.5">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $availableFloors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $floor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <button
                                        ...
                                        class="rounded-lg border px-3 py-1 text-xs font-semibold transition <?php echo e($floorFilter === $floor ? 'border-teal-600 bg-teal-600 text-white dark:bg-teal-700 dark:border-teal-500' : 'border-gray-200 bg-white text-gray-600 hover:border-teal-600 hover:bg-teal-50 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-300 dark:hover:border-teal-600 dark:hover:bg-teal-900/20'); ?>"
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $locationChunks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <div class="grid w-full shrink-0 grid-cols-3 gap-2" style="min-width:100%">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $chunk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                ...
                                                >
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($displayPct > 0): ?>
                                                        <span
                                                            class="pointer-events-none absolute bottom-0 left-0 right-0 transition-all duration-500 bg-opacity-20"
                                                            :style="'height: <?php echo e($displayPct); ?>%; background: ' + <?php echo \Illuminate\Support\Js::from($fillColor)->toHtml() ?>"
                                                            aria-hidden="true"
                                                        ></span>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                                                    <span class="line-clamp-2 leading-tight relative z-10"><?php echo e($location['display_name']); ?></span>

                                                    
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isVerified && $locTotal > 0): ?>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($i = count($chunk); $i % 3 !== 0; $i++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                <div></div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($cell = 0; $cell < $cellCount; $cell++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                ...
                                <button type="button"
                                        ...
                                        class="relative flex aspect-square items-center justify-center rounded-xl text-sm font-semibold transition-all
                                            ...
                                            <?php echo e($isToday && ! $isSelected ? 'ring-2 ring-sky-500 ring-offset-1' : ''); ?>
                                            ...
                                            <?php if($isSelected): ?> bg-gradient-to-br from-slate-800 to-teal-700 <?php endif; ?>">
...
<?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showPhotoReview): ?>
                    <?php
                    ...
                    <div class="fixed inset-0 z-50 flex flex-col bg-white dark:bg-zinc-900">
                        <div class="flex items-center justify-between px-4 py-3 text-white bg-gradient-to-r from-slate-800 to-teal-700">
                            <button
                                ...
                                aria-label="<?php echo e(__('Back')); ?>">
                                <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7"/>
                                </svg>
                            </button>
                            <h2 class="text-base font-semibold"><?php echo e(__('Photo Review')); ?></h2>
                            <span class="rounded-full bg-white/20 px-2 py-1 text-xs font-medium"><?php echo e($selectedLocation); ?></span>
                        </div>
                        <div class="border-b border-zinc-200 px-4 py-2 dark:border-zinc-700">
                            <div class="mb-2 flex items-center justify-between text-xs text-zinc-600 dark:text-zinc-300">
                                <span><?php echo e($reviewedCount); ?> / <?php echo e($totalCount); ?> <?php echo e(__('reviewed')); ?></span>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($allReviewed && $missingCommentCount === 0): ?>
                                    <span class="text-green-600 dark:text-green-400"><?php echo e(__('Ready to submit')); ?></span>
                                <?php elseif($allReviewed): ?>
                                    <span class="text-amber-600 dark:text-amber-400"><?php echo e(__('Missing comments')); ?></span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            <div class="h-2 w-full overflow-hidden rounded-full bg-zinc-200 dark:bg-zinc-700">
                                <div class="<?php echo e($progressColor); ?> h-full transition-all duration-300" :style="'width: ' + <?php echo e($progressPercent); ?> + '%'"></div>
                            </div>
                            <div class="mt-2 flex gap-2">
                                <button
                                    type="button"
                                    wire:click="setPhotoReviewTab('all')"
                                    class="rounded-full px-3 py-1 text-xs font-medium transition <?php echo e($photoReviewTab === 'all' ? 'bg-zinc-800 text-white dark:bg-white dark:text-zinc-800' : 'bg-zinc-100 text-zinc-600 hover:bg-zinc-200 dark:bg-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-700'); ?>">
                                    <?php echo e(__('All')); ?> (<?php echo e($allCount); ?>)
                                </button>
                                <button
                                    type="button"
                                    wire:click="setPhotoReviewTab('AM')"
                                    class="rounded-full px-3 py-1 text-xs font-medium transition <?php echo e($photoReviewTab === 'AM' ? 'bg-orange-500 text-white dark:bg-orange-600' : 'bg-zinc-100 text-zinc-600 hover:bg-zinc-200 dark:bg-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-700'); ?>">
                                    <?php echo e(__('AM')); ?> (<?php echo e($amCount); ?>)
                                </button>
                                <button
                                    type="button"
                                    wire:click="setPhotoReviewTab('PM')"
                                    class="rounded-full px-3 py-1 text-xs font-medium transition <?php echo e($photoReviewTab === 'PM' ? 'bg-sky-500 text-white dark:bg-sky-600' : 'bg-zinc-100 text-zinc-600 hover:bg-zinc-200 dark:bg-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-700'); ?>">
                                    <?php echo e(__('PM')); ?> (<?php echo e($pmCount); ?>)
                                </button>
                            </div>
                        </div>
                        <div class="flex-1 overflow-auto p-3">
                            <div class="grid grid-cols-3 gap-2">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $areaParts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $part): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $shifts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shift): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <?php
                                        ...
                                        <button
                                            type="button"
                                            wire:click="openPhotoModal('<?php echo e($slotKey); ?>')"
                                            <?php if($isDisabled): ?> disabled <?php endif; ?>
                                            class="relative rounded-lg border-2 <?php echo e($borderColor); ?> bg-white p-2 text-left transition dark:bg-zinc-800 <?php echo e($isDisabled ? 'pointer-events-none opacity-50' : 'hover:border-zinc-400 dark:hover:border-zinc-500'); ?>">
                                            <div class="aspect-square w-full overflow-hidden rounded bg-zinc-100 dark:bg-zinc-700">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasProof): ?>
                                                    <img src="<?php echo e($this->buildProofPreviewUrl($proofPath)); ?>" alt="<?php echo e($part['display_name']); ?>" class="h-full w-full object-cover">
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($state['checked'] === true): ?>
                                                ...
                                                <?php else: ?>
                                                    <div class="flex h-full w-full items-center justify-center bg-zinc-200 dark:bg-zinc-700">
                                                        <span class="text-2xl font-bold text-zinc-400 dark:text-zinc-500"><?php echo e(strtoupper(substr($part['display_name'], 0, 1))); ?></span>
                                                    </div>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </div>
                                            <div class="mt-1">
                                                <div class="truncate text-xs font-medium text-zinc-700 dark:text-zinc-200"><?php echo e($part['display_name']); ?></div>
                                                <div class="flex items-center gap-1">
                                                    <span class="rounded bg-zinc-100 px-1 py-0.5 text-[10px] font-semibold dark:bg-zinc-700 <?php echo e($shift === 'AM' ? 'text-orange-600 dark:text-orange-400' : 'text-sky-600 dark:text-sky-400'); ?>"><?php echo e($shift); ?></span>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(trim($state['comment'] ?? '') !== ''): ?>
                                                    ...
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($state['checked'] === false && trim($state['comment'] ?? '') === ''): ?>
                        ...
                        <div class="sticky bottom-0 border-t border-zinc-200 bg-white px-4 py-3 dark:border-zinc-700 dark:bg-zinc-900">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showCheckAllConfirm): ?>
                                <div class="mb-2 flex items-center justify-between rounded-lg bg-amber-50 px-3 py-2 dark:bg-amber-900/20">
                                    <span class="text-sm font-medium text-amber-800 dark:text-amber-200"><?php echo e(__('Check all remaining items?')); ?></span>
                            ...
                            <div class="flex gap-2">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$photoReviewSubmitted): ?>
                                    <button
                                        ...
                                        <?php if($allChecked): ?> disabled <?php endif; ?>
                                        class="flex-1 rounded-md border py-2 text-sm font-medium transition <?php echo e($allChecked ? 'border-green-300 bg-green-50 text-green-700 dark:border-green-700 dark:bg-green-900/20 dark:text-green-400' : 'border-zinc-300 bg-white text-zinc-700 hover:bg-zinc-50 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-200 dark:hover:bg-zinc-700'); ?>">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($allChecked): ?>
                                            <?php echo e(__('All items checked')); ?>

                                        <?php else: ?>
                                            <?php echo e(__('Check all')); ?> (<?php echo e($remainingCount); ?> <?php echo e(__('remaining')); ?>)
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </button>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <button
                                    ...
                                    <?php if(!$allReviewed || $missingCommentCount > 0 || $photoReviewSubmitted): ?> disabled <?php endif; ?>
                                    class="flex-1 rounded-md py-2 text-sm font-medium transition
                                        <?php echo e($photoReviewSubmitted
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($photoReviewSubmitted): ?>
                                        <?php echo e(__('✓ Verified — submitted')); ?>

                                    <?php elseif(!$allReviewed): ?>
                                        <?php echo e(__($reviewedCount . ' items not yet reviewed')); ?>

                                    <?php elseif($missingCommentCount > 0): ?>
                                        <?php echo e(__($missingCommentCount . ' unchecked items need a comment')); ?>

                                    <?php else: ?>
                                        <?php echo e(__('Verified — tap to submit')); ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showPhotoModal): ?>
                        <div class="fixed inset-0 z-50 flex items-end justify-center bg-black/60" wire:click="closePhotoModal">
                            <div class="w-full max-w-lg rounded-t-xl bg-white pb-6 dark:bg-zinc-900" wire:click.stop>
                                <div class="flex items-center justify-between border-b border-zinc-200 px-4 py-3 dark:border-zinc-700">
                                    ...
                                    ?>
                                    <span class="text-sm font-medium text-zinc-600 dark:text-zinc-300"><?php echo e(($currentPos !== false ? $currentPos + 1 : 0) . ' / ' . $totalFiltered); ?></span>
                                ...
                                ?>
                                <div class="p-4">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isModalSkip): ?>
                                        <div class="flex flex-col items-center gap-3 rounded-xl border border-amber-200 bg-amber-50 px-4 py-8 text-center dark:border-amber-700/40 dark:bg-amber-900/20">
                                            <span class="flex h-12 w-12 items-center justify-center rounded-full bg-amber-100 dark:bg-amber-800/40">
                                                <svg class="h-6 w-6 text-amber-600 dark:text-amber-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                            ...
                                            <div>
                                                <p class="text-sm font-semibold text-amber-800 dark:text-amber-300"><?php echo e(__('Photo Skipped')); ?></p>
                                                <p class="mt-1 text-xs text-amber-700 dark:text-amber-400"><?php echo e(substr($modalProofPath, 5)); ?></p>
                                            </div>
                                        </div>
                                    <?php elseif($hasModalProof): ?>
                                        <div class="aspect-[4/3] w-full overflow-hidden rounded-lg bg-zinc-100 dark:bg-zinc-800">
                                            <img src="<?php echo e($this->buildProofPreviewUrl($modalProofPath)); ?>" alt="<?php echo e($modalPart['display_name'] ?? ''); ?>" class="h-full w-full object-contain">
                                        </div>
                                    <?php else: ?>
                                        <div class="aspect-[4/3] w-full overflow-hidden rounded-lg bg-zinc-200 dark:bg-zinc-700">
                                            <div class="flex h-full w-full items-center justify-center">
                                                <span class="text-4xl font-bold text-zinc-400 dark:text-zinc-500"><?php echo e(strtoupper(substr($modalPart['display_name'] ?? '', 0, 1))); ?></span>
                                            </div>
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <div class="mt-3 flex items-center gap-2">
                                        <span class="font-medium text-zinc-800 dark:text-zinc-100"><?php echo e($modalPart['display_name'] ?? ''); ?></span>
                                        <span class="rounded bg-zinc-100 px-2 py-0.5 text-xs font-semibold dark:bg-zinc-700 <?php echo e($modalShift === 'AM' ? 'text-orange-600 dark:text-orange-400' : 'text-sky-600 dark:text-sky-400'); ?>"><?php echo e($modalShift); ?></span>
                                    </div>
                                    <div class="mt-4">
                                        ...
                                        <textarea
                                            ...
                                            rows="2"
                                            placeholder="<?php echo e($currentState['checked'] === false ? __('Comment required when unchecked...') : __('Add comment (optional)...')); ?>"
                                            class="mt-1 w-full rounded-md border px-3 py-2 text-sm focus:outline-none focus:ring-1 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 <?php echo e($photoModalCommentError ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-zinc-300 focus:border-sky-500 focus:ring-sky-500'); ?>"></textarea>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($photoModalCommentError): ?>
                                            <p class="mt-1 text-xs text-red-500"><?php echo e(__('Comment required when unchecked')); ?></p>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                    <button
                                        type="button"
                                        wire:click="togglePhotoCheck"
                                        class="mt-4 w-full rounded-md py-2 text-sm font-medium transition <?php echo e($currentState['checked'] === true ? 'bg-green-500 text-white hover:bg-green-600 dark:bg-green-600 dark:hover:bg-green-700' : 'border border-zinc-300 bg-white text-zinc-700 hover:bg-zinc-50 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-200 dark:hover:bg-zinc-700'); ?>">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentState['checked'] === true): ?>
                                            <?php echo e(__('✓ Checked')); ?>

                                        <?php else: ?>
                                            <?php echo e(__('Mark as checked')); ?>
...
</div><?php /**PATH D:\nlahweb\nlahinventory\storage\framework/views/livewire/views/e12ecb9f.blade.php ENDPATH**/ ?>