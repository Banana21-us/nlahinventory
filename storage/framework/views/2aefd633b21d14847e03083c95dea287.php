...
<style>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $periods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
        <?php
        ...
        ?>
        <button type="button"
            wire:click="openModal('<?php echo e($p['key']); ?>')"
            ...
            <div class="flex items-center justify-between mb-3">
                <div>
                    <p class="text-xs font-bold uppercase tracking-wide text-gray-500"><?php echo e($p['label']); ?></p>
                    <p class="text-[10px] text-gray-400"><?php echo e($p['sub']); ?></p>
                </div>
                <div class="p-2 rounded-lg <?php echo e($iconBg); ?>">
                    <svg class="w-4 h-4 <?php echo e($iconColor); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <?php else: ?>
                <p class="text-3xl font-bold <?php echo e($numColor); ?>">
                    <?php echo e($p['done']); ?><span class="text-lg text-gray-400 font-normal">/<?php echo e($p['total']); ?></span>
                </p>
                <p class="text-xs text-gray-500 mt-1"><?php echo e($pct); ?>% complete</p>
                <div class="mt-3 w-full bg-gray-100 rounded-full h-1.5">
                    <div class="<?php echo e($barColor); ?> h-1.5 rounded-full transition-all" style="width: <?php echo e($pct); ?>%"></div>
                </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
        <a href="<?php echo e(route('Maintenance.checklist.check')); ?>" wire:navigate
        ...
        <a href="<?php echo e(route('users.leaveform')); ?>" wire:navigate
           class="m-card p-4 sm:p-5 flex items-center gap-3 sm:gap-4 hover:bg-gray-50 transition-colors group">
    ...
    <div class="m-card overflow-hidden">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recentRecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
            <div class="px-5 py-4 border-b border-gray-50 flex items-start gap-4 last:border-0">
                <div class="mt-1 shrink-0">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rec->verifier_status === 'YES'): ?>
                        <span class="w-2.5 h-2.5 rounded-full m-bg-green block"></span>
                    <?php elseif($rec->verifier_status === 'NO'): ?>
                        <span class="w-2.5 h-2.5 rounded-full m-bg-red block"></span>
                    <?php elseif($rec->status === 'YES'): ?>
                ...
                <div class="flex-1 min-w-0">
                    <p class="text-sm font-bold text-gray-900 truncate"><?php echo e($rec->part_name); ?></p>
                    <p class="text-xs text-gray-500"><?php echo e($rec->location_name); ?> · <?php echo e($rec->location_floor); ?></p>
                    <p class="text-xs font-medium text-[#1e3a5f] mt-0.5"><?php echo e($rec->maintenance_name); ?></p>
                </div>

                <div class="text-right shrink-0">
                    <p class="text-xs font-semibold text-gray-700"><?php echo e(\Carbon\Carbon::parse($rec->cleaning_date)->format('M d')); ?></p>
                    <div class="flex items-center gap-1 justify-end mt-1">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rec->shift): ?>
                            <span class="text-[10px] px-1.5 py-0.5 rounded font-bold"
                                  style="<?php echo e($rec->shift === 'AM' ? 'background:#fef3c7;color:#92400e;' : 'background:#e0e7ff;color:#3730a3;'); ?>">
                                <?php echo e($rec->shift); ?>

                            </span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <span class="text-[10px] px-1.5 py-0.5 rounded bg-gray-100 text-gray-500 font-medium capitalize">
                            <?php echo e($rec->period_type); ?>
        ...
        <div class="relative bg-white w-full sm:max-w-2xl sm:rounded-2xl rounded-t-2xl shadow-2xl flex flex-col max-h-[90vh]">
            ...
            <div class="flex items-center justify-between px-5 py-4 border-b border-gray-100 shrink-0">
                <div>
                    ...
                    <h2 class="text-lg font-bold text-gray-900 capitalize"><?php echo e($modalPeriod); ?> Tasks</h2>
                </div>
            ...
            <div class="overflow-y-auto flex-1">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $modalRows ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                <?php
                ...
                <div class="px-5 py-4 border-b border-gray-50 flex items-start gap-3 last:border-0">
                    <span class="w-2.5 h-2.5 rounded-full <?php echo e($dot); ?> mt-1.5 shrink-0 block"></span>

                    <div class="flex-1 min-w-0">
                        <p class="text-sm font-semibold text-gray-900"><?php echo e($row->part_name); ?></p>
                        <p class="text-xs text-gray-400"><?php echo e($row->location_name); ?>

                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($row->location_floor): ?> · <?php echo e($row->location_floor); ?> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </p>
                    </div>
                    ...
                    <div class="text-right shrink-0 space-y-1">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($done): ?>
                            <p class="text-sm font-bold text-[#1e3a5f]"><?php echo e($row->maintenance_name); ?></p>
                            <div class="flex items-center gap-1 justify-end">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($row->shift): ?>
                                    <span class="text-[10px] px-1.5 py-0.5 rounded font-bold"
                                          style="<?php echo e($row->shift === 'AM' ? 'background:#fef3c7;color:#92400e;' : 'background:#e0e7ff;color:#3730a3;'); ?>">
                                        <?php echo e($row->shift); ?>

                                    </span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($row->verifier_status === 'YES'): ?>
                                    <span class="text-[10px] px-1.5 py-0.5 rounded bg-green-100 text-green-700 font-bold">Verified</span>
                                <?php elseif($row->verifier_status === 'NO'): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    <div class="px-5 py-12 text-center text-gray-400">
                        ...
                        <p class="text-xs mt-1">Add entries to location_area_parts with frequency="<?php echo e($modalPeriod); ?>".</p>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
...
<?php /**PATH C:\Users\JOHNPAUL\OneDrive\Documents\GitHub\nlahinventory\resources\views/pages/Maintenance/dashboard.blade.php ENDPATH**/ ?>