...
<div class="max-w-7xl mx-auto py-8 px-4">
    ...
    <div class="bg-white shadow-md rounded-lg border border-gray-200 overflow-hidden"
        ...
        <button
            @click="open = !open; if(!open) window.Livewire.find('<?php echo e($_instance->getId()); ?>').cancelForm()"
        ...
        >
            <div class="flex items-center">
                ...
                <h2 class="text-lg font-bold text-gray-800">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isEditing): ?> Edit News / Event <?php else: ?> News / Event Entry <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </h2>
            </div>
            <span class="text-sm font-medium brand-text-blue"
                  x-text="open ? 'Minimize' : '<?php echo e($isEditing ? 'Edit Entry' : 'Add News / Event'); ?>'">
            </span>
        </button>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['newsType'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1 block"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['newsCategory'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1 block"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    <label class="block text-xs font-bold uppercase tracking-wide text-gray-500 mb-1">
                        Image <?php echo e($isEditing ? '(Leave empty to keep current)' : '*'); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <?php elseif($oldImage && $isEditing): ?>
                        <div class="mt-2 flex items-center gap-2">
                            <p class="text-xs text-gray-400">Current image:</p>
                            <img src="<?php echo e(asset('storage/news/' . $oldImage)); ?>"
                                 class="h-12 w-12 object-cover rounded-lg border border-gray-200"/>
                        </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="lg:col-span-3 flex justify-end items-center gap-3 pt-4 border-t border-gray-100 mt-2">
                    <button type="button"
                            @click="open = false; window.Livewire.find('<?php echo e($_instance->getId()); ?>').cancelForm()"
                    ...
                    <button type="submit"
                        ...
                        <span wire:loading.remove wire:target="save">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isEditing): ?> Update <?php else: ?> Publish <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </span>
    ...
    <div class="mt-8 bg-white shadow-md rounded-lg overflow-hidden border border-gray-200">
        ...
        <div class="bg-gray-50 px-6 py-4 border-b border-gray-200 flex flex-wrap gap-3 justify-between items-center">
            <div class="flex items-center gap-3">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($News instanceof \Illuminate\Pagination\LengthAwarePaginator): ?>
                    <span class="text-sm text-gray-500 bg-gray-100 px-3 py-1 rounded-full font-medium">
                        <?php echo e($News->total()); ?> <?php echo e(Str::plural('entry', $News->total())); ?>

                    </span>
                <?php else: ?>
                    <span class="text-sm text-gray-500 bg-gray-100 px-3 py-1 rounded-full font-medium">
                        <?php echo e($News->count()); ?> <?php echo e(Str::plural('entry', $News->count())); ?>
                            ...
                            <div class="flex items-center justify-between mb-2 text-xs text-gray-400">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->location): ?>
                                    <span class="flex items-center gap-1 truncate max-w-[130px]">
                                        ...
                                        <span class="truncate"><?php echo e($item->location); ?></span>
                                    </span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>

                            
                            <h3 class="text-sm font-bold text-gray-900 mb-2 leading-snug"><?php echo e($item->title); ?></h3>

                            
                            <details class="flex-1 group mb-3">
                                <summary class="flex items-start justify-between cursor-pointer list-none gap-2">
                                    <p class="text-xs text-gray-500 line-clamp-2">
                                        <?php echo e(\Str::words($item->description, 14, '…')); ?>
                                ...
                                <div class="mt-2 p-3 rounded-lg text-xs text-gray-600 brand-bg-blue-light">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isEvent): ?>
                                        <p class="mb-1 font-semibold"><?php echo e(\Carbon\Carbon::parse($item->date)->format('F d, Y')); ?></p>
                                        <p class="mb-2 text-gray-500"><?php echo e($item->location); ?></p>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($News instanceof \Illuminate\Pagination\LengthAwarePaginator && $News->hasPages()): ?>
            <div class="px-6 py-4 border-t border-gray-100 bg-gray-50 flex flex-col sm:flex-row items-center justify-between gap-2">
                <p class="text-xs text-gray-400">
                    Showing <?php echo e($News->firstItem()); ?>–<?php echo e($News->lastItem()); ?> of <?php echo e($News->total()); ?> results
                </p>
...
</div><?php /**PATH C:\Users\JOHNPAUL\OneDrive\Documents\GitHub\nlahinventory\resources\views/pages/NewsPage/newshr.blade.php ENDPATH**/ ?>