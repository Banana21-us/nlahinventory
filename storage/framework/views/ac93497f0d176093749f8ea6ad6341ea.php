...
unset($__defined_vars, $__key, $__value); ?>
    ...
    <?php if (! $__env->hasRenderedOnce('98059426-3662-4b6c-9c65-e91ab1e96151')): $__env->markAsRenderedOnce('98059426-3662-4b6c-9c65-e91ab1e96151'); ?>
    <style>
    ...
    <div id="proofCaptureModal" class="fixed inset-0 z-50 hidden bg-black/70 p-2 overflow-y-auto" wire:ignore.self>
        <div class="w-full max-w-sm mx-auto bg-white shadow-2xl dark:bg-zinc-900 rounded-xl overflow-hidden">
            <div class="flex items-center justify-between border-b border-zinc-200 px-3 py-2 dark:border-zinc-700">
                <h3 class="text-sm font-semibold text-zinc-900 dark:text-zinc-100"><?php echo e(__('Capture Proof Photo')); ?></h3>
            ...
            <div class="p-3 max-h-[calc(100vh-20px)] sm:max-h-[calc(100vh-24px)] overflow-y-auto">
                <div class="flex flex-col gap-2">
                    ...
                    <div class="flex items-center justify-between gap-2">
                        ...
                        <div class="hidden flex items-center gap-1 rounded-full border border-zinc-200 bg-white p-0.5 text-[11px] dark:border-zinc-700 dark:bg-zinc-900 shrink-0" role="group" aria-label="<?php echo e(__('Shift')); ?>" data-shift-group>
                    ...
                    <div id="proofStepIndicator" class="flex gap-2 overflow-x-auto pb-1 justify-start">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $areaParts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $part): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <?php
                                $amChecked = false;
                                $pmChecked = false;
                                if ($periodType === 'daily') {
                            ...
                            <div
                                ...
                                data-day-key="<?php echo e($dayKey); ?>"
                                data-has-am="<?php echo e($amChecked ? '1' : '0'); ?>"
                                data-has-pm="<?php echo e($pmChecked ? '1' : '0'); ?>"
                                data-area-part="<?php echo e($part['display_name']); ?>"
                                data-location="<?php echo e($selectedLocation); ?>"
                                data-frequency="<?php echo e($periodType); ?>"
                                data-date-label="<?php echo e($selectedDate ? \Carbon\Carbon::parse($selectedDate)->format('M d, Y') : ''); ?>"
                                data-captured-by="<?php echo e(auth()->user()?->name ?? ''); ?>"
                                data-step-index="<?php echo e($index); ?>"
                            >
                                ...
                                <span class="text-[9px] text-center text-zinc-500 dark:text-zinc-400 leading-tight w-full min-h-[1.8em]"><?php echo e($part['display_name']); ?></span>
                            </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            <p class="text-xs text-zinc-400 py-2"><?php echo e(__('No area parts available')); ?></p>
                    ...
                    <div class="w-full space-y-2">
                        <div class="relative aspect-square w-full overflow-hidden rounded-lg bg-zinc-100 dark:bg-zinc-800">
                            ...
                            <img id="proofPreview" class="hidden h-full w-full rounded-lg bg-black object-cover" alt="<?php echo e(__('Proof preview')); ?>">
                        </div>
                        ...
                        <div class="flex items-center justify-center gap-4">
                            ...
                            <button type="button" id="proofCaptureOverlayBtn"
                                ...
                                aria-label="<?php echo e(__('Capture photo')); ?>">
                        ...
                        <div class="flex flex-wrap items-center justify-between gap-2">
                           <input type="text" id="proofCommentInput" placeholder="<?php echo e(__('Add comment (optional)...')); ?>"
                            ...
                            <div class="ms-auto flex items-center gap-2">
                                ...
                                <button type="button" id="proofConfirmBtn" class="hidden rounded-md bg-emerald-600 px-4 py-2 text-sm font-medium text-white hover:bg-emerald-700"><?php echo e(__('Confirm')); ?></button>
                                <button type="button" id="proofCancelBtn" class="rounded-md border border-zinc-300 px-4 py-2 text-sm font-medium text-zinc-700 hover:bg-zinc-100 dark:border-zinc-700 dark:text-zinc-200 dark:hover:bg-zinc-800"><?php echo e(__('Cancel')); ?></button>
                            </div>
                        </div>
                    </div>
  ...
  <?php if (! $__env->hasRenderedOnce('1ac78614-bf28-4e9e-8913-0494fe0c809c')): $__env->markAsRenderedOnce('1ac78614-bf28-4e9e-8913-0494fe0c809c'); ?>
<script>
(() => {
...
<?php endif; ?><?php /**PATH C:\Users\admin\Documents\GitHub\nlah\resources\views/components/checklist-proof-camera-modal.blade.php ENDPATH**/ ?>