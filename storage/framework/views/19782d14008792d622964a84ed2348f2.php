        ...
        <div class="bg-gray-50 px-6 py-4 border-b border-gray-200 flex flex-wrap gap-3 justify-between items-center">
            <div class="flex items-center gap-3">
                ...
                <span class="text-sm text-gray-500 bg-gray-100 px-3 py-1 rounded-full font-medium">
                    <?php echo e($positions->count()); ?> <?php echo e(Str::plural('position', $positions->count())); ?>
        ...
        <div class="overflow-x-auto">
            <table class="w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-100">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $positions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <tr class="brand-row-hover transition-colors">

                            <td class="px-6 py-4">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pos->code): ?>
                            ...
                            <td class="px-6 py-4">
                                <p class="text-sm font-bold text-gray-900"><?php echo e($pos->name); ?></p>
                            </td>

                            <td class="px-6 py-4">
                                <p class="text-sm text-gray-500"><?php echo e($pos->description ?? '—'); ?></p>
                            </td>

                            <td class="px-6 py-4 text-right text-sm font-medium space-x-2">
                                <button wire:click="edit(<?php echo e($pos->id); ?>)"
                                    class="brand-edit-btn rounded-md px-2.5 py-1.5 text-sm font-semibold shadow-sm transition-colors">
                                    Edit
                                </button>
                                <button wire:click="confirmDelete(<?php echo e($pos->id); ?>)"
                            ...
                            <td colspan="4" class="px-6 py-14 text-center">
                                <div class="flex flex-col items-center text-gray-400">
                                    ...
                                    <p class="text-sm font-medium">
                                        <?php echo e($search ? 'No positions match your search.' : 'No positions found.'); ?>

                                    </p>
                                    <p class="text-xs mt-1">
                                        <?php echo e($search ? 'Try a different keyword.' : 'Click "Add New Position" above to get started.'); ?>
...
<?php /**PATH C:\Users\JOHNPAUL\OneDrive\Documents\GitHub\nlahinventory\resources\views/pages/HR/position-management.blade.php ENDPATH**/ ?>