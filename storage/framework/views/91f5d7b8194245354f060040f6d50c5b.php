...
<header class="fixed top-6 left-0 right-0 z-50 flex justify-center px-4" wire:ignore>
    <nav class="flex items-center justify-between w-full max-w-4xl h-14 px-4 bg-white/70 backdrop-blur-xl border border-zinc-200/50 rounded-full shadow-sm">
        ...
        <div class="flex items-center gap-2 pl-2">
            <a href="<?php echo e(route('nlah.home')); ?>" class="flex items-center gap-2 hover:opacity-80 transition-opacity">
        ...
        <div class="hidden md:flex items-center gap-6 text-[13px] font-medium text-zinc-600">
            <a href="<?php echo e(route('nlah.home')); ?>"
               class="<?php echo e(request()->routeIs('nlah.home') ? 'text-black font-semibold' : 'hover:text-black transition-colors'); ?>">
                Home
            </a>
            <a href="<?php echo e(route('nlah.services')); ?>"
               class="<?php echo e(request()->routeIs('nlah.services') ? 'text-black font-semibold' : 'hover:text-black transition-colors'); ?>">
                Services
            </a>
            <a href="<?php echo e(route('nlah.about')); ?>"
               class="<?php echo e(request()->routeIs('nlah.about') ? 'text-black font-semibold' : 'hover:text-black transition-colors'); ?>">
                About Us
            </a>
            <a href="<?php echo e(route('nlah.news')); ?>"
               class="<?php echo e(request()->routeIs('nlah.news') ? 'text-black font-semibold' : 'hover:text-black transition-colors'); ?>">
                Events
            </a>
    ...
    <div id="mobile-menu"
        ...
        <div class="flex flex-col p-2">
            ...
            <a href="<?php echo e(route('nlah.home')); ?>" onclick="closeMobileMenu()"
               class="flex items-center px-4 py-3 rounded-xl text-sm font-medium transition-colors <?php echo e(request()->routeIs('nlah.home') ? 'bg-zinc-100 text-black' : 'text-zinc-700 hover:bg-zinc-50 hover:text-black'); ?>">
                Home
            </a>
            <a href="<?php echo e(route('nlah.services')); ?>" onclick="closeMobileMenu()"
               class="flex items-center px-4 py-3 rounded-xl text-sm font-medium transition-colors <?php echo e(request()->routeIs('nlah.services') ? 'bg-zinc-100 text-black' : 'text-zinc-700 hover:bg-zinc-50 hover:text-black'); ?>">
                Services
            </a>
            <a href="<?php echo e(route('nlah.about')); ?>" onclick="closeMobileMenu()"
               class="flex items-center px-4 py-3 rounded-xl text-sm font-medium transition-colors <?php echo e(request()->routeIs('nlah.about') ? 'bg-zinc-100 text-black' : 'text-zinc-700 hover:bg-zinc-50 hover:text-black'); ?>">
                About Us
            </a>
            <a href="<?php echo e(route('nlah.news')); ?>" onclick="closeMobileMenu()"
               class="flex items-center px-4 py-3 rounded-xl text-sm font-medium transition-colors <?php echo e(request()->routeIs('nlah.news') ? 'bg-zinc-100 text-black' : 'text-zinc-700 hover:bg-zinc-50 hover:text-black'); ?>">
                Events
            </a>
            ...
            <div>
                ...
                <div id="options-body" style="display:none;"
                    ...
                    <a href="<?php echo e(route('login')); ?>" onclick="closeMobileMenu()"
        ...
        <div class="border-t border-zinc-100 p-2">
            ...
            <div class="flex flex-col gap-1">
                ...
                <a href="<?php echo e(route('register')); ?>" onclick="closeMobileMenu()"
...
[$__name, $__params] = $__split('bot', []);

$key = null;
$__componentSlots = [];

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3033742164-0', $key);
...
<?php /**PATH C:\Users\JOHNPAUL\OneDrive\Documents\GitHub\nlahinventory\resources\views/livewire/navigation.blade.php ENDPATH**/ ?>