    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
                ...
                <p class="text-3xl font-extrabold text-gray-800 mt-2"><?php echo e($stats['total_items']); ?></p>
            </div>
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
                <p class="text-xs font-bold text-green-500 uppercase tracking-wider">Active Supply</p>
                <p class="text-3xl font-extrabold text-gray-800 mt-2"><?php echo e($stats['active_stock']); ?></p>
            </div>
            <div class="bg-white rounded-xl shadow-sm border border-red-100 p-5">
                ...
                <p class="text-3xl font-extrabold text-red-600 mt-2"><?php echo e($stats['low_stock']); ?></p>
            </div>
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
                    ...
                    <ul class="divide-y divide-gray-100">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $lowStockItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <li class="px-4 py-3 flex justify-between items-center hover:bg-gray-50">
                                <div>
                                    <p class="text-sm font-semibold text-gray-800"><?php echo e($item->generic_name); ?></p>
                                    <p class="text-xs text-gray-500"><?php echo e($item->brand_name); ?></p>
                                </div>
                                <span class="bg-red-100 text-red-700 text-[10px] font-bold px-2 py-1 rounded">Lv: <?php echo e($item->reorder_level); ?></span>
                            </li>
...
</div><?php /**PATH C:\Users\JOHNPAUL\OneDrive\Documents\GitHub\nlahinventory\resources\views/pages/Medmission/dashboard.blade.php ENDPATH**/ ?>