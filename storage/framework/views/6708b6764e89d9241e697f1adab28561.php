    ...
    <div class="flex items-center justify-between mb-6">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <h1 class="text-xl font-bold text-gray-800 leading-tight">Inventory</h1>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white shadow-md rounded-lg border border-gray-200 overflow-hidden"
        ...
        >
            <div class="flex items-center">
                ...
                <h2 class="text-lg font-bold text-gray-800">Inventory Entry</h2>
            </div>
            <span class="text-sm font-medium text-amber-600" x-text="open ? 'Minimize' : 'Add / Restock Item'"></span>
        </button>
        ...
        >
            <form wire:submit.prevent="save" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="md:col-span-2">
                    <label class="block text-xs font-bold uppercase tracking-wide text-gray-500 mb-1">Item *</label>
                    <select
                        wire:model="item_id"
                    ...
                    >
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $this->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <option value="<?php echo e($item->id); ?>">
                                <?php echo e($item->name); ?><?php echo e($item->type ? ' · ' . $item->type : ''); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    <label class="block text-xs font-bold uppercase tracking-wide text-gray-500 mb-1">Quantity *</label>
                    <input
                        type="number"
                        wire:model="quantity"
                        min="0"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <p class="text-xs text-gray-400 mt-1">
                        If the item already has a record, this quantity will be
                        <span class="font-semibold text-amber-600">added</span> to the existing stock.
                    </p>
                </div>
    ...
    <div class="mt-8 bg-white shadow-md rounded-lg overflow-hidden border border-gray-200">
        ...
        <div class="bg-gray-50 px-6 py-4 border-b border-gray-200 flex flex-wrap gap-3 justify-between items-center">
            <div class="flex items-center gap-3">
                ...
                <h3 class="text-lg font-bold text-gray-800">Stock Levels</h3>
                <span class="text-sm text-gray-500 bg-gray-100 px-3 py-1 rounded-full font-medium">
                    <?php echo e($this->inventories->count()); ?> <?php echo e(Str::plural('record', $this->inventories->count())); ?>
        ...
        <div class="overflow-x-auto">
            <table class="w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-100">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $this->inventories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inventory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <?php
                            $item     = $inventory->item;
                            $imgUrl   = $item->image
                                ? Storage::disk('public')->url($item->image)
                                : asset('images/placeholder.png');
                            $lowStock = $inventory->quantity > 0 && $inventory->quantity <= 5;
                        ...
                        <tr class="hover:bg-amber-50/40 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-2">
                                    <span class="text-sm font-bold
                                        <?php echo e($noStock ? 'text-red-600' : ($lowStock ? 'text-amber-600' : 'text-gray-800')); ?>">
                                        <?php echo e(number_format($inventory->quantity)); ?>

                                    </span>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($noStock): ?>
                            ...
                            <td class="px-6 py-4 text-right text-sm font-medium space-x-2">
                                <button
                                    wire:click="edit(<?php echo e($inventory->id); ?>)"
                                ...
                                <button
                                    wire:click="confirmDelete(<?php echo e($inventory->id); ?>)"
                            ...
                            <td colspan="6" class="px-6 py-14 text-center">
                                <div class="flex flex-col items-center text-gray-400">
                                    ...
                                    <p class="text-sm font-medium">
                                        <?php echo e($search ? 'No items match your search.' : 'No inventory records yet.'); ?>

                                    </p>
                                    <p class="text-xs mt-1">
                                        <?php echo e($search ? 'Try a different keyword.' : 'Click "Add / Restock Item" above to get started.'); ?>
                ...
                <div class="relative transform overflow-hidden rounded-xl bg-white text-left shadow-xl sm:w-full sm:max-w-lg">
                    <div class="bg-white px-6 pt-6 pb-4">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h3 class="text-base font-bold text-gray-900">Delete Inventory Record</h3>
                                <p class="mt-1.5 text-sm text-gray-500">
                                    Are you sure you want to remove this inventory record? The stock count for this item will be cleared. This action cannot be undone.
                                </p>
                            </div>
                        </div>
                    </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <p class="text-xs text-gray-400 mt-1">
                                        This sets the <span class="font-semibold text-amber-600">exact</span> stock quantity for this item.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-gray-50 px-6 py-4 flex flex-row-reverse gap-3 rounded-b-xl">
                            <button type="submit"
                                class="inline-flex justify-center rounded-lg bg-amber-500 px-5 py-2 text-sm font-bold
                                       text-white shadow-sm hover:bg-amber-600 transition-colors active:scale-95 flex items-center gap-2">
...
</div><?php /**PATH C:\Users\admin\Documents\GitHub\nlah\resources\views/pages/POSuser/Inventory.blade.php ENDPATH**/ ?>