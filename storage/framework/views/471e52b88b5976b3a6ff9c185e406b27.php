...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1886997706-0', $key);
...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('register')); ?>" class="flex flex-col gap-6">
            <?php echo csrf_field(); ?>

            <!-- Employee Number + Auto Name -->
            <div x-data="{
                empNumber: '<?php echo e(old('employee_number')); ?>',
                ...
                lookup() {
                    ...
                    this.loading = true;
                    this.error = '';
                    fetch('<?php echo e(route('employee.lookup')); ?>?employee_number=' + encodeURIComponent(this.empNumber))
                        .then(r => r.json())
                        .then(data => {
                            if (data.found) {
                                this.name = data.name;
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::input.index','data' => ['name' => 'employee_number','label' => __('Employee Number'),'type' => 'text','required' => true,'xModel' => 'empNumber','@blur' => 'lookup','autofocus' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'employee_number','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Employee Number')),'type' => 'text','required' => true,'x-model' => 'empNumber','@blur' => 'lookup','autofocus' => true]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                ...
                <div>
                    <label class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1"><?php echo e(__('Full Name')); ?></label>
                    <div class="relative">
                        <input
                            type="text"
                            name="name"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <?php if (isset($component)) { $__componentOriginal26c546557cdc09040c8dd00b2090afd0 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal26c546557cdc09040c8dd00b2090afd0 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::input.index','data' => ['name' => 'username','label' => __('Username'),'value' => old('username'),'required' => true,'autocomplete' => 'username','placeholder' => 'juan.delacruz']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'username','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Username')),'value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('username')),'required' => true,'autocomplete' => 'username','placeholder' => 'juan.delacruz']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\JOHNPAUL\OneDrive\Documents\GitHub\nlahinventory\resources\views/pages/auth/register.blade.php ENDPATH**/ ?>